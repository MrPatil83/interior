...
const Home = () => {
  ...
  // Modified whatCanItems array with dynamic routes
  const whatCanItems = [
    {
      id: 1,
      title: "Office",
      imgSrc: office,
      alt: "office image",
      link: "/portfolio/office", // Updated link
    },
    {
      id: 2,
      title: "Appartment",
      imgSrc: appartment,
      alt: "appartment image",
      link: "/portfolio/appartment", // Updated link
    },
    {
      id: 3,
      title: "Bedroomarea",
    ...
    },
    {
      ...
      imgSrc: livingarea,
      alt: "livingarea image",
      link: "/portfolio/livingarea", // Updated link
    },
    {
      id: 6,
      title: "Cafe/Resturant",
      imgSrc: caferesturant,
      alt: "caferesturant image",
      link: "/portfolio/caferesturant", // Updated link
    },
    {
      id: 7,
      title: "Bathroom",
      imgSrc: bathroom,
      alt: "bathroom image",
      link: "/portfolio/bathroom", // Updated link
    },
    {
      id: 8,
      title: "Clasroom",
      imgSrc: clasroom,
      alt: "clasroom image",
      link: "/portfolio/clasroom", // Updated link
    },
    {
      id: 9,
      title: "House",
      imgSrc: house,
      alt: "house image",
      link: "/portfolio/house", // Updated link
    },
  ];
    ...
    <section className="-mt-24 overflow-hidden">
      ...
      <div className="flex justify-center flex-col h-[100vh] mx-auto items-center text-center px-[20rem]">
        ...
        <motion.p
          ...
          className="text-base mx-auto -ml-[15rem] flex lg:px-10 text-zinc-500 md:poppins-regular md:w-screen md:-mx-14 md:text-xl lg:text-xl lg:w-screen lg:-mb-14 xl:w-auto xl:ml-4"
        >
          "By embracing 'Bringing Nature Home,' interior spaces not only reflect
          a contemporary aesthetic but also promote well-being, sustainability,
          and a deeper appreciation for the beauty and serenity found in the
          natural world."
        </motion.p>
      </div>
      ...
      <section className="flex flex-cols-3 justify-around h-[210rem] lg:h-[73rem] mx-auto md:h-[117rem] mt-24 bg-stone-900 rounded-se-full">
        <div>
          <motion.div
            ...
            className="poppins-regular mx-auto px-10 text-zinc-500 mb-4 py-10 text-[2rem] md:text-3xl md:pl-4 lg:text-4xl"
          >
            <span className="text-slate-500">What you can do in</span> STEADLERS
            & SCALES
          </motion.div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {whatCanItems.map((item) => (
